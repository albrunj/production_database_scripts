...
from itk_pdb.databaseUtilities import checkITkDBAuth
from itk_pdb.databaseUtilities import Colours
from itk_pdb.databaseUtilities import commands as dbCommands
...
class Inventory(object):
    ...
    def listComponentTypes(self):
        ...
        INFO('Printing list of component types associated with project code \'{0}\':\n'.format(self.project))
