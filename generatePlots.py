...
class PlotMaker(ITkPDSession):
    ...
    def __getCuts(self, **kwargs):
        ...
        if kwargs['upperDate'] != None:
            ...
            cuts['upperDate'] = lambda component: not self.__cutOnValueWithOperator(component, '>=', kwargs['upper'], ['cts', '0:10'])
    ...
    def __addToCounterWithStages(self, component, counter, *args):
        try:
    ...
    def makePlots(self, **kwargs):
        ...
        try:
            ...
            if kwargs['currentLocation'] != None or kwargs['institution'] != None:
                ...
                # These Lines have been problematic when using the GUI, fix later
...
if __name__ == '__main__':
    ...
    try:
        ...
        optional.add_argument('-x', '--split', dest = 'split', type = str, choices = [None, 'type', 'currentStage', 'currentLocation', 'institution'], default = None, help = 'draw a separate plot for each new category under the split type')
...
def generatePlotsFromKwargs(kwargs, token): # Add session here
    ...
    plotMaker = PlotMaker(False)
    plotMaker.updateToken(token)
    print(kwargs["institution"])
    plotMaker = plotMaker.makePlots(**kwargs)
    STATUS('Finished successfully.', True)
