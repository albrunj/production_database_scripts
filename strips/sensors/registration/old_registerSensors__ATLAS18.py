...
# VF, 2021-08-05: copied over the code changes from *_noHM.py script (dated 2021-06-13 there): 
# Changes:
...
# VF, 2021-06-13: since we want the end state to be "disassembled"...
    ...
    dto_in_halfmoons = {
        ...
        'properties' :      {'ID': id_HM, 'DATE_RECEIVED': date_received},
        'batches':          {batch_code: batch_number}
    }
...
# VF, 2021-06-13: since we want the end state to be "disassembled"...
    ...
    if do_qa:
        ...
        dto_in_qamini = {
            ...
            'batches':          {batch_code: batch_number},
            'properties':{'ID': id_MIM, 'DATE_RECEIVED': date_received, 'WAFER_POSITION_LABEL':wafer_pos_label_mini}
        }
        ...
        dto_in_qachip = {
            ...
            'batches':          {batch_code: batch_number},
            'properties':{'ID': id_TCM, 'DATE_RECEIVED': date_received, 'WAFER_POSITION_LABEL':wafer_pos_label_chip}
        }
