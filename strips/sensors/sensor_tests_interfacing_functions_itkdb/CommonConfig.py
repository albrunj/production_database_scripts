"""###Author: David Rousso, Dominic Jones and Pavla Federicova"""
...
ITK_COMPONENTTYPE="SENSOR_S_TEST"
#######NEW FROM VITALIY
...
TestType_Visual_Inspection='ATLAS18_VIS_INSPECTION_V2'
...
FormatFilesDict={
         ...
         TestType_Visual_Inspection :"STANDARD_2021_4_VI.txt",
        }        
...
DisplayFieldsForTestTypes={
    ...
    TestType_Visual_Inspection:{'Decision':'',
                        'Filename':'',
                        'Timestamp':'',
                        'Flags':'',
                        },
...
APIAlternateNamesValues={
    ...
    'Location4'             :['LOCATION4'],
    'DamageType4'           :['DAMAGETYPE4'],
    'Location5'             :['LOCATION5'],
    'DamageType5'           :['DAMAGETYPE5'],
    'Location6'             :['LOCATION6'],
    'DamageType6'           :['DAMAGETYPE6'],
}
...
if ITK_COMPONENTTYPE=='SENSOR':
    picklefilename=abspath(join(dirname(__file__),'SENSOR__ITK_Test_Dictionary_List_Pickle.txt') )
    APIpicklefilename=abspath(join(dirname(__file__),'SENSOR__API_ITK_Test_Dictionary_List_Pickle.txt' ))
if ITK_COMPONENTTYPE=="SENSOR_S_TEST":
    picklefilename=abspath(join(dirname(__file__),'SENSOR_S_TEST__ITK_Test_Dictionary_List_Pickle.txt' ))
    APIpicklefilename=abspath(join(dirname(__file__),'SENSOR_S_TEST__API_ITK_Test_Dictionary_List_Pickle.txt' ))
...
#print("APIParam,",APIParamTypeList, "\n")   
#print ("APITestType,", APITestType)
...
for APITestType in APITestTypeList:
    ...
    for APIParam in [i['code'] for i in APITestType['properties']]:
        ...
        #print("APIParamList,",APIParamTypeList)
...
def DateTime2Timestamp(date,time):
    ...
    for TimeFormat in range(0,len(TimeRegexStringList)):
        ...
        try:
            ...
            efpprint("Something wrong with Time format.")
            continue
    try:
