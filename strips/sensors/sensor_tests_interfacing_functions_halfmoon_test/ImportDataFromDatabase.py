...
from CommonConfig import ITK_MAIN_COMPONENT
...
def ImportDataFromDatabase():
    ...
    #print("APITestTypeList,",APITestTypeList ) #plni se dobre
    ...
    for TestType in TestTypeList:
        ...
        '''
    for TestRun in (client.get("listTestRunsByTestType", json = {"project": ITK_PROJECT, 'componentType':ITK_MAIN_COMPONENT, 'testType':'ATLAS18_MAIN_THICKNESS_V1'} )):
        APITestList.append(TestRun)  
    '''  
    APITestList.extend(dbAccess.extractList("listTestRunsByTestType", method = "GET",
                                data = {
                                    "project": ITK_PROJECT,
                                    'componentType':ITK_MAIN_COMPONENT, 
                                    'testType':'ATLAS18_MAIN_THICKNESS_V1'
                                })
                    )
    '''  
    ...
    for i in APITESTLIST:
        ...
        print("NAME,",APITestDict['components'][0]['serialNumber'])
        ...
        if Name is not None:
            Name=Name.upper()
       # Name=APITestDict['components'][0]['alternativeIdentifier'].upper() 
