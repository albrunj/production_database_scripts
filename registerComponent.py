            ...
            while True:
                ...
                try:
                    ...
                    if len(component_types) == 0:
                        ...
                        k, self.json['componentType'] = self.__askForSomething('Enter a component type code associated with your project and institution:', component_types)
                    ...
                    if stages == None or len(stages) == 0:
